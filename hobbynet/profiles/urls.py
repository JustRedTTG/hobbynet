...
urlpatterns = [
    ...
    path('<int:pk>/<slug:slug>/', views.ProfileDetails.as_view(), name='profile_details'),
    path('<int:pk>/<slug:slug>/<int:topic_pk>/<slug:topic_slug>', views.ProfileDetails.as_view(), name='profile_details_topic'),
]